/*******************************************************************************
 * (c) Copyright 2011-2016 Microsemi SoC Products Group.  All rights reserved.
 *
...
/* This variable is used for do not lock the page,
...
#define AUX_DATA_WC_MASK    0x00FFFFF0u
...
#define PROTECT_USER_MASK                   0x9999u
#define READ_ONLY                           0x1u
#define WRITE_ONLY                          0x8u
#define NO_READ_WRITE                       0x0u
#define WRITE_ENABLED                       (WRITE_ONLY | READ_ONLY)
...
/**************************************************************************//**
 * Check protection region and reserved region of eNVM
 *
 * 005 device
